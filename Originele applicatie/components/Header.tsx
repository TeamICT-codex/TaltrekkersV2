    ...
    <header className="bg-surface shadow-sm sticky top-0 z-40 border-b border-themed">
      <div className="container mx-auto px-4 md:px-8 py-3 flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          >
             <svg width="48" height="48" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
              <rect width="100" height="100" rx="20" fill="var(--color-brand)" />
              <g transform="translate(10, 10)">
                  <circle cx="28" cy="45" r="18" fill="white" />
                  <circle cx="62" cy="45" r="18" fill="var(--color-primary)" />
                  <circle cx="45" cy="45" r="18" fill="var(--color-secondary)" />
              </g>
            </svg>
            <div>
              ...
              <div className="font-extrabold text-base sm:text-lg text-brand leading-tight">
