      ...
      <div className="w-full h-96 perspective-1000">
        ...
        <div key={currentIndex} className="w-full h-full animate-fade-in relative">
          ...
          >
            ...
            <div className="absolute w-full h-full backface-hidden bg-surface-alt rounded-2xl shadow-lg flex flex-col justify-between p-6 cursor-pointer border border-themed rotate-y-180 overflow-y-auto">
              <div>
